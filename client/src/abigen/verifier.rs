...
#[derive(Debug, Clone)]
pub struct Groth16VerifierBN254<A: starknet::accounts::ConnectedAccount + Sync> {
    pub address: starknet::core::types::Felt,
    pub account: A,
    pub block_id: starknet::core::types::BlockId,
}
impl<A: starknet::accounts::ConnectedAccount + Sync> Groth16VerifierBN254<A> {
...
#[derive(Debug, Clone)]
pub struct Groth16VerifierBN254Reader<P: starknet::providers::Provider + Sync> {
    pub address: starknet::core::types::Felt,
    pub provider: P,
    pub block_id: starknet::core::types::BlockId,
}
impl<P: starknet::providers::Provider + Sync> Groth16VerifierBN254Reader<P> {
...
impl<A: starknet::accounts::ConnectedAccount + Sync> Groth16VerifierBN254<A> {
    ...
    pub fn verify_groth16_proof_bn254(
        ...
        A::Provider,
        Option<Vec<cainome::cairo_serde::U256>>,
    > {
        use cainome::cairo_serde::CairoSerde;
        ...
        __calldata
            .extend(
                ...
                >::cairo_serialize(full_proof_with_hints),
            );
